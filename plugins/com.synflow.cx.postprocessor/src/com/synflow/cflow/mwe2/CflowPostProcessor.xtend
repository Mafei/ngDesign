 ...
 *******************************************************************************/
package com.synflow.cflow.mwe2
...
/**
 * This class defines a post-processor for the Cflow model.
 * 
 * @author Matthieu Wipliez
 */
class CflowPostProcessor {

	def static augment(GeneratedMetamodel metamodel) {
		new CflowPostProcessor().process(metamodel)
	}

	new() {
		System.out.println('running CflowPostProcessor v20140317')
	}
	...
	def private addDataTypes(EPackage p) {
		...
		// adds type for com.synflow.cflow.internal.ErrorMarker
		val typeErrorMarker = EcoreFactory.eINSTANCE.createEDataType
		typeErrorMarker.instanceClassName = 'com.synflow.cflow.internal.ErrorMarker'
