 ...
 * <ul>
 * <li>{@link com.synflow.models.ir.impl.InstPhiImpl#getOldVariable <em>Old Variable</em>}</li>
 * <li>{@link com.synflow.models.ir.impl.InstPhiImpl#getTarget <em>Target</em>}</li>
 * <li>{@link com.synflow.models.ir.impl.InstPhiImpl#getValues <em>Values</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
		...
		if (newTarget != target) {
			...
			if (target != null)
				msgs = ((InternalEObject) target).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- IrPackage.INST_PHI__TARGET, null, msgs);
			if (newTarget != null)
