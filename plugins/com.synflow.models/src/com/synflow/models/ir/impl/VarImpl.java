 ...
 * <ul>
 * <li>{@link com.synflow.models.ir.impl.VarImpl#isAssignable <em>Assignable</em>}</li>
 * <li>{@link com.synflow.models.ir.impl.VarImpl#getDefs <em>Defs</em>}</li>
 * <li>{@link com.synflow.models.ir.impl.VarImpl#isGlobal <em>Global</em>}</li>
 * <li>{@link com.synflow.models.ir.impl.VarImpl#getIndex <em>Index</em>}</li>
 * <li>{@link com.synflow.models.ir.impl.VarImpl#getInitialValue <em>Initial Value</em>}</li>
 * <li>{@link com.synflow.models.ir.impl.VarImpl#getLineNumber <em>Line Number</em>}</li>
 * <li>{@link com.synflow.models.ir.impl.VarImpl#isLocal <em>Local</em>}</li>
 * <li>{@link com.synflow.models.ir.impl.VarImpl#getName <em>Name</em>}</li>
 * <li>{@link com.synflow.models.ir.impl.VarImpl#getType <em>Type</em>}</li>
 * <li>{@link com.synflow.models.ir.impl.VarImpl#getUses <em>Uses</em>}</li>
 * <li>{@link com.synflow.models.ir.impl.VarImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VarImpl extends EObjectImpl implements Var {
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID,
		...
		switch (featureID) {
		case IrPackage.VAR__DEFS:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getDefs()).basicAdd(
					otherEnd, msgs);
		case IrPackage.VAR__USES:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getUses()).basicAdd(
					otherEnd, msgs);
		}
	...
	public boolean isLocal() {
		EObject cter = eContainer();
		return (cter instanceof Procedure || isParam() || cter instanceof Pattern);
	}

	@Override
	public boolean isParam() {
		return eContainingFeature() == IrPackage.Literals.PROCEDURE__PARAMETERS;
	}
		...
		if (newInitialValue != initialValue) {
			...
			if (initialValue != null)
				msgs = ((InternalEObject) initialValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- IrPackage.VAR__INITIAL_VALUE, null, msgs);
