 ...
 * <ul>
 * <li>{@link com.synflow.models.ir.impl.BlockIfImpl#getCondition <em>Condition</em>}</li>
 * <li>{@link com.synflow.models.ir.impl.BlockIfImpl#getElseBlocks <em>Else Blocks</em>}</li>
 * <li>{@link com.synflow.models.ir.impl.BlockIfImpl#getJoinBlock <em>Join Block</em>}</li>
 * <li>{@link com.synflow.models.ir.impl.BlockIfImpl#getLineNumber <em>Line Number</em>}</li>
 * <li>{@link com.synflow.models.ir.impl.BlockIfImpl#getThenBlocks <em>Then Blocks</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BlockIfImpl extends BlockImpl implements BlockIf {
		...
		if (newCondition != condition) {
			...
			if (condition != null)
				msgs = ((InternalEObject) condition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- IrPackage.BLOCK_IF__CONDITION, null, msgs);
	...
	public void setJoinBlock(BlockBasic newJoinBlock) {
		if (newJoinBlock != joinBlock) {
			NotificationChain msgs = null;
			if (joinBlock != null)
				msgs = ((InternalEObject) joinBlock).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- IrPackage.BLOCK_IF__JOIN_BLOCK, null, msgs);
			if (newJoinBlock != null)
				msgs = ((InternalEObject) newJoinBlock).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
						- IrPackage.BLOCK_IF__JOIN_BLOCK, null, msgs);
