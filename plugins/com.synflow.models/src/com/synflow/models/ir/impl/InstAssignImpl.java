 ...
 * <ul>
 * <li>{@link com.synflow.models.ir.impl.InstAssignImpl#getTarget <em>Target</em>}</li>
 * <li>{@link com.synflow.models.ir.impl.InstAssignImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
		...
		if (newTarget != target) {
			...
			if (target != null)
				msgs = ((InternalEObject) target).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- IrPackage.INST_ASSIGN__TARGET, null, msgs);
			if (newTarget != null)
		...
		if (newValue != value) {
			...
			if (value != null)
				msgs = ((InternalEObject) value).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- IrPackage.INST_ASSIGN__VALUE, null, msgs);
			if (newValue != null)
