 ...
 * <ul>
 * <li>{@link com.synflow.models.ir.impl.ExprVarImpl#getUse <em>Use</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExprVarImpl extends ExpressionImpl implements ExprVar {
	...
	public void setUse(Use newUse) {
		if (newUse != use) {
			...
			if (use != null)
				msgs = ((InternalEObject) use).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- IrPackage.EXPR_VAR__USE, null, msgs);
			if (newUse != null)
				msgs = ((InternalEObject) newUse).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
						- IrPackage.EXPR_VAR__USE, null, msgs);
