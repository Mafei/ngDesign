 ...
 * <ul>
 * <li>{@link com.synflow.models.ir.impl.InstStoreImpl#getIndexes <em>Indexes</em>}</li>
 * <li>{@link com.synflow.models.ir.impl.InstStoreImpl#getTarget <em>Target</em>}</li>
 * <li>{@link com.synflow.models.ir.impl.InstStoreImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InstStoreImpl extends InstructionImpl implements InstStore {
		...
		if (newTarget != target) {
			...
			if (target != null)
				msgs = ((InternalEObject) target).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- IrPackage.INST_STORE__TARGET, null, msgs);
			if (newTarget != null)
		...
		if (newValue != value) {
			...
			if (value != null)
				msgs = ((InternalEObject) value).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- IrPackage.INST_STORE__VALUE, null, msgs);
			if (newValue != null)
	...
	public String toString() {
		...
		return builder.append(", ").append(new ExpressionPrinter().toString(getValue()))
				.append(")").toString();
	}
