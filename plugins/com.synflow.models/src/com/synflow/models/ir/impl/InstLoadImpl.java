 ...
 * <ul>
 * <li>{@link com.synflow.models.ir.impl.InstLoadImpl#getIndexes <em>Indexes</em>}</li>
 * <li>{@link com.synflow.models.ir.impl.InstLoadImpl#getSource <em>Source</em>}</li>
 * <li>{@link com.synflow.models.ir.impl.InstLoadImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
		...
		if (newSource != source) {
			...
			if (source != null)
				msgs = ((InternalEObject) source).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- IrPackage.INST_LOAD__SOURCE, null, msgs);
			if (newSource != null)
		...
		if (newTarget != target) {
			...
			if (target != null)
				msgs = ((InternalEObject) target).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- IrPackage.INST_LOAD__TARGET, null, msgs);
			if (newTarget != null)
