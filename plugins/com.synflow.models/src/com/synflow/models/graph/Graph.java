...
public interface Graph extends Vertex {
	...
	/**
	 * Returns the first vertex of this graph. The first vertex, if it exists, is the one vertex of
	 * the graph that has no incoming edges. If there are no such vertices, or several such
	 * vertices, this method returns <code>null</code>.
	 * 
	...
	/**
	 * Returns the last vertex of this graph. The last vertex, if it exists, is the one vertex of
	 * the graph that has no outgoing edges. If there are no such vertices, or several such
	 * vertices, this method returns <code>null</code>.
	 * 
