 ...
 * <li>{@link com.synflow.models.dpn.impl.EntityImpl#getParameters <em>Parameters</em>}</li>
...
public class EntityImpl extends EObjectImpl implements Entity {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case DpnPackage.ENTITY__OUTPUTS:
			return getOutputs();
		case DpnPackage.ENTITY__PARAMETERS:
	...
	public boolean eIsSet(int featureID) {
		...
		case DpnPackage.ENTITY__PROPERTIES:
			return PROPERTIES_EDEFAULT == null ? properties != null : !PROPERTIES_EDEFAULT
					.equals(properties);
		case DpnPackage.ENTITY__PROCEDURES:
