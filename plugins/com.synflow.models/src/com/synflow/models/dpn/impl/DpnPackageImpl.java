...
public class DpnPackageImpl extends EPackageImpl implements DpnPackage {
	...
	public static DpnPackage init() {
		...
		DpnPackageImpl theDpnPackage = (DpnPackageImpl) (EPackage.Registry.INSTANCE.get(eNS_URI) instanceof DpnPackageImpl ? EPackage.Registry.INSTANCE
				.get(eNS_URI) : new DpnPackageImpl());
	...
	public void initializePackageContents() {
		...
		initEReference(getAction_InputPattern(), this.getPattern(), null, "inputPattern", null, 0,
				...
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAction_OutputPattern(), this.getPattern(), null, "outputPattern", null,
		...
		initEReference(getActor_Actions(), this.getAction(), null, "actions", null, 0, -1,
				...
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getActor_ActionsOutsideFsm(), this.getAction(), null, "actionsOutsideFsm",
				null, 0, -1, Actor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
		...
		initEClass(argumentEClass, Argument.class, "Argument", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getArgument_Value(), theIrPackage.getExpression(), null, "value", null, 0,
				1, Argument.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getEntity_Outputs(), this.getPort(), null, "outputs", null, 0, -1,
				Entity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEntity_Parameters(), theIrPackage.getVar(), null, "parameters", null, 0,
				-1, Entity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getEntity_Procedures(), theIrPackage.getProcedure(), null, "procedures",
				null, 0, -1, Entity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getEntity_Variables(), theIrPackage.getVar(), null, "variables", null, 0,
				-1, Entity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
