...
public interface ILaunchConfigurationConstants {
	...
	String CHECK_PORTS = "com.synflow.ui.configuration.checkPorts";

	String CLASS = "com.synflow.ui.launchClass";

	String CREATE_VCD = "com.synflow.ui.configuration.createVcd";
	...
	String ENABLE_ASSERTIONS = "com.synflow.ui.configuration.enableAssertions";

	String NUM_CYCLES = "com.synflow.ui.configuration.numberOfCycles";

	String PRINT_CYCLES = "com.synflow.ui.configuration.printCycles";

	String PROJECT = "com.synflow.ui.launchProject";

	String TYPE_SIMULATION = "com.synflow.ui.launchConfigurationSimulation";
